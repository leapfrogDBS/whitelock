    ...
    <div class="container">
        <div class="row lg:gap-x-8"> 
            ...
            <div class="col lg:col-span-4 lg:order-1 lg:text-left">
                <img loading="lazy" class="h-6 w-auto mx-auto my-6 lg:ml-0 lg:h-7" src="<?php echo get_stylesheet_directory_uri(); ?>/img/shield.png" alt="">
                    ...
                    <?php     
                        ...
                        ?>
                            <div class="lg:flex lg:mb-6 lg:gap-x-4 lg:text-left">
                                <img loading="lazy" class="h-5 w-auto mx-auto my-4 lg:m-0" src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-tick.png" alt="">
