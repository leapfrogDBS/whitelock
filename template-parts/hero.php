...
?>
<section class="bg-cover py-20" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/img/hero-background.png')">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="headingOne"><?php echo $hero_headline; ?></h1>
                <div class="poi-container">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/white-tick.png" class="h-5 w-auto" alt="">
